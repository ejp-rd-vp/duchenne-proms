...
#puts "nutrition_clauses.rdf", promlist.class
#puts "nutrition_clauses.rdf", promlist.first
...
ordered.each do |question|
  ...
  clause = %{
    ...
    puts "nutrition_clauses.rdf", clause
    questions = questions + %{<rdf:Description rdf:about="https://w3id.org/duchenne-proms#DDP_#{number}"/>\n}
    count +=1
      
end

puts "nutrition_clauses.rdf", %{
    <owl:Class rdf:about="https://w3id.org/duchenne-proms#nutrition_section">
        <owl:equivalentClass>
            <owl:Restriction>
...
#{questions}
        ...
        <rdfs:subClassOf rdf:resource="http://semanticscience.org/resource/SIO_000171"/>
               <rdfs:label rdf:datatype="http://www.w3.org/2001/XMLSchema#string">Nutrition Section</rdfs:label>
